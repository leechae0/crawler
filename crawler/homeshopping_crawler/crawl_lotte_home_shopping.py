...
def get_image_url_by_prod_id(prod_id):
    url = 'http://image2.lotteimall.com/goods/{0}/{1}/{2}/{3}_H.jpg'.format(
        prod_id[6:8],
        prod_id[4:6],
        prod_id[2:4],
        prod_id,
...
def lotte_home_shopping(window_arrow):
    ...
    for item in item_list:
        ...
        view_list = item.find_all('div', {'class': 'rn_tsitem_view'})
        ...
        yield ProductInfo(
            ...
            shop_code='7',
            ch_no = '6',
            shop_prod_id=prod_id,
            product_id='003611'+prod_id,
            image=image_url,
        )
...
# for product in lotte_home_shopping(arrow.get('2017-04-25')):
#     print(product)
